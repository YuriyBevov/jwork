...
import styles from './select-tab-type-4.module.scss';

const selectItem = (item: HeroItem) => {
  switch (item.type) {
    case 'select':
      return <SelectUi radius="xl" item={item} />;
    case 'multi_select':
      return (
        <MultiSelectUi
          radius="xl"
    ...
    case 'price_range':
      return <PriceRangeDropdownUi radius="xl" item={item} />;
    default:
      return null;
  }
};

export const SelectTabType_4 = ({
  data,
  className,
}: {
  data: HeroDTO;
