...
import custom from './header-type-4.module.scss';

export const HeaderType_4 = ({ data }: { data: HeaderDTO }) => {
  ...
  return (
    <header className={clsx(common.root, custom.root)}>
      <div className="container">
        ...
        >
          <div className={custom.header_top}>
          ...
          <div className={custom.header_bottom}>
