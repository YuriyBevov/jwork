...
import { ResultListTypeColumn_5 } from '../../../result-list-column/components/result-list-type-column-5';
import { ResultListType_5 } from '../../../result-list/components/result-list-type-5';
import { ResultListDTO } from '../../types';

export const ViewResultListType_5 = () => {
  ...
  return (
    <MainSectionLayout align={data.titleAlign}>
      ...
      />
      {isContent ? (
        <ResultListType_5 data={data} />
      ) : (
        <ResultListTypeColumn_5
          data={data}
