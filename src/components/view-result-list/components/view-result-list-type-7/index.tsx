...
import { ResultListTypeColumn_7 } from '../../../result-list-column/components/result-list-type-column-7';
import { ResultListType_7 } from '../../../result-list/components/result-list-type-7';
import { ResultListDTO } from '../../types';

export const ViewResultListType_7 = () => {
  ...
  return (
    <MainSectionLayout align={data.titleAlign}>
      ...
      />
      {isContent ? (
        <ResultListType_7 data={data} />
      ) : (
        <ResultListTypeColumn_7
          data={data}
