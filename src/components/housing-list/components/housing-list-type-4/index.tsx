...
import custom from './housing-list-type-4.module.scss';

export const HousingListType_4 = async () => {
  const data: HousingListDTO = await getLocalData(
    'src/components/housing-list/components/housing-list-type-4/data.json',
  );
