...
import custom from './housing-list-type-6.module.scss';

export const HousingListType_6 = async () => {
  const data: HousingListDTO = await getLocalData(
    'src/components/housing-list/components/housing-list-type-6/data.json',
  );
