...
import custom from './housing-list-type-5.module.scss';

export const HousingListType_5 = async () => {
  const data: HousingListDTO = await getLocalData(
    'src/components/housing-list/components/housing-list-type-5/data.json',
  );
