...
import custom from './housing-list-type-2.module.scss';

export const HousingListType_2 = async () => {
  const data: HousingListDTO = await getLocalData(
    'src/components/housing-list/components/housing-list-type-2/data.json',
  );
