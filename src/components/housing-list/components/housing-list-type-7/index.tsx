...
import custom from './housing-list-type-7.module.scss';

export const HousingListType_7 = async () => {
  const data: HousingListDTO = await getLocalData(
    'src/components/housing-list/components/housing-list-type-7/data.json',
  );
