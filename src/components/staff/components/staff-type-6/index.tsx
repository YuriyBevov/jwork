...
import custom from './staff-type-6.module.scss';

export const StaffType_6 = async () => {
  const data: StaffDTO = await getLocalData(
    'src/components/staff/components/staff-type-6/data.json',
  );
