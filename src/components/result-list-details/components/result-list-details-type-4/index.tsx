...
import custom from './result-list-details-type-4.module.scss';
...
export const ResultLisDetailstType_4 = async () => {
  const data: ResultListDetalilsDTO = await getLocalData(
    'src/components/result-list-details/components/result-list-details-type-4/data.json',
  );
