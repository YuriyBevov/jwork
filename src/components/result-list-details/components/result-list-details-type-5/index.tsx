...
import custom from './result-list-details-type-5.module.scss';

export const ResultLisDetailstType_5 = async () => {
  const data: ResultListDetalilsDTO = await getLocalData(
    'src/components/result-list-details/components/result-list-details-type-5/data.json',
  );
