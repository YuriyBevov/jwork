...
import custom from './result-list-details-type-3.module.scss';

export const ResultLisDetailstType_3 = async () => {
  const data: ResultListDetalilsDTO = await getLocalData(
    'src/components/result-list-details/components/result-list-details-type-3/data.json',
  );
