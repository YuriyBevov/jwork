...
import custom from './result-list-details-type-2.module.scss';

export const ResultLisDetailstType_2 = async () => {
  const data: ResultListDetalilsDTO = await getLocalData(
    'src/components/result-list-details/components/result-list-details-type-2/data.json',
  );
