...
import custom from './result-list-details-type-1.module.scss';

export const ResultLisDetailstType_1 = async () => {
  const data: ResultListDetalilsDTO = await getLocalData(
    'src/components/result-list-details/components/result-list-details-type-1/data.json',
  );
