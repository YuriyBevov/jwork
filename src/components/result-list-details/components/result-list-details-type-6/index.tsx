...
import custom from './result-list-details-type-6.module.scss';

export const ResultLisDetailstType_6 = async () => {
  const data: ResultListDetalilsDTO = await getLocalData(
    'src/components/result-list-details/components/result-list-details-type-6/data.json',
  );
