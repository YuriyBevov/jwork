...
import custom from './result-list-details-alt-type-5.module.scss';

export const ResultLisDetailstAltType_5 = async () => {
  const data: ResultListDetalilsAltDTO = await getLocalData(
    'src/components/result-list-details-alt/components/result-list-details-alt-type-5/data.json',
  );
