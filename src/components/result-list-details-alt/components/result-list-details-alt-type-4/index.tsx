...
import custom from './result-list-details-alt-type-4.module.scss';

export const ResultLisDetailstAltType_4 = async () => {
  const data: ResultListDetalilsAltDTO = await getLocalData(
    'src/components/result-list-details-alt/components/result-list-details-alt-type-4/data.json',
  );
