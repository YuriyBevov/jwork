...
import custom from './result-list-details-alt-type-1.module.scss';

export const ResultLisDetailstAltType_1 = async () => {
  const data: ResultListDetalilsAltDTO = await getLocalData(
    'src/components/result-list-details-alt/components/result-list-details-alt-type-1/data.json',
  );
