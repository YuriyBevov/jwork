...
import common from '../result-list-details-alt.module.scss';
import custom from './result-list-details-alt-type-3.module.scss';

export const ResultLisDetailstAltType_3 = async () => {
  const data: ResultListDetalilsAltDTO = await getLocalData(
    'src/components/result-list-details-alt/components/result-list-details-alt-type-3/data.json',
  );
