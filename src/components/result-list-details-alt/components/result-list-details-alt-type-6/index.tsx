...
import custom from './result-list-details-alt-type-6.module.scss';

export const ResultLisDetailstAltType_6 = async () => {
  const data: ResultListDetalilsAltDTO = await getLocalData(
    'src/components/result-list-details-alt/components/result-list-details-alt-type-6/data.json',
  );
