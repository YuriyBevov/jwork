...
import custom from './result-list-details-alt-type-2.module.scss';

export const ResultLisDetailstAltType_2 = async () => {
  const data: ResultListDetalilsAltDTO = await getLocalData(
    'src/components/result-list-details-alt/components/result-list-details-alt-type-2/data.json',
  );
