...
import custom from './result-list-details-alt-type-7.module.scss';

export const ResultLisDetailstAltType_7 = async () => {
  const data: ResultListDetalilsAltDTO = await getLocalData(
    'src/components/result-list-details-alt/components/result-list-details-alt-type-7/data.json',
  );
